...
class DetailParse:
    ...
    def get_stock(self):
        element_str = self.sel.css("#availability").get()
        if element_str.__contains__("Currently unavailable"):
            return -1
        else:
            return 0
    ...
    def get_data(self) -> None:
        ...
        if self.response:
            ...
            self.data["stock"] = self.get_stock()
            ...
            self.data['class'] = 'com.common.mongo.mo.CollectAmazonProductMO'
            self.data['mainImageIsOcr'] = False
            self.data['machine_mark_code'] = ""
    ...
    def get_profile(self) -> None:
        ...
        self.profile['class'] = 'com.common.mongo.mo.CollectAmazonNoteMO'
        self.profile['exceptionType'] = self.screen()
        self.profile['remark'] = self.remark
        self.profile['machine_mark_code'] = ""
